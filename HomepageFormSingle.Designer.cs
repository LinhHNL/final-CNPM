...
namespace WinFormsApp2
{
    partial class HomepageFormSingle
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btn_showprice
            // 
            btn_showprice.AutoSize = true;
            btn_showprice.BackColor = Color.Black;
            btn_showprice.FlatAppearance.BorderColor = Color.Black;
            btn_showprice.FlatAppearance.BorderSize = 0;
            btn_showprice.FlatStyle = FlatStyle.Flat;
            btn_showprice.Font = new Font("Calibri", 13.8F, FontStyle.Regular, GraphicsUnit.Point);
            btn_showprice.ForeColor = Color.White;
            btn_showprice.ImageAlign = ContentAlignment.TopRight;
            btn_showprice.Location = new Point(393, 12);
            btn_showprice.Name = "btn_showprice";
            btn_showprice.Size = new Size(356, 38);
            btn_showprice.TabIndex = 2;
            btn_showprice.Text = "đ 0";
            btn_showprice.TextAlign = ContentAlignment.TopRight;
            ...
            panel_monan_1.Location = new Point(738, 112);
