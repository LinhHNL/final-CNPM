namespace WinFormsApp2.KhoPage
{
    partial class KiemKhoXuatHang
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            btn_PhieuXuatHang = new CustomControls.RoundedButton();
            metroGrid1 = new MetroFramework.Controls.MetroGrid();
            dgv_XuatHang = new MetroFramework.Controls.MetroGrid();
            ...
            ((System.ComponentModel.ISupportInitialize)dgv_XuatHang).BeginInit();
            ...
            label1.TabIndex = 29;
            label1.Text = "Xuất hàng";
            // 
            // btn_PhieuXuatHang
            // 
            btn_PhieuXuatHang.BackColor = Color.FromArgb(253, 197, 183);
            btn_PhieuXuatHang.BackgroundColor = Color.FromArgb(253, 197, 183);
            btn_PhieuXuatHang.BorderColor = Color.FromArgb(215, 122, 125);
            btn_PhieuXuatHang.BorderRadius = 8;
            btn_PhieuXuatHang.BorderSize = 1;
            btn_PhieuXuatHang.FlatAppearance.BorderColor = Color.FromArgb(230, 57, 70);
            btn_PhieuXuatHang.FlatStyle = FlatStyle.Flat;
            btn_PhieuXuatHang.Font = new Font("Calibri", 12F, FontStyle.Regular, GraphicsUnit.Point);
            btn_PhieuXuatHang.ForeColor = Color.FromArgb(229, 1, 17);
            btn_PhieuXuatHang.Location = new Point(999, 78);
            btn_PhieuXuatHang.Margin = new Padding(3, 4, 3, 4);
            btn_PhieuXuatHang.Name = "btn_PhieuXuatHang";
            btn_PhieuXuatHang.Size = new Size(175, 35);
            btn_PhieuXuatHang.TabIndex = 30;
            btn_PhieuXuatHang.Text = "+ Phiếu xuất hàng";
            btn_PhieuXuatHang.TextColor = Color.FromArgb(229, 1, 17);
            btn_PhieuXuatHang.UseVisualStyleBackColor = false;
            btn_PhieuXuatHang.Click += btn_PhieuXuatHang_Click;
            // 
            // metroGrid1
            // 
            ...
            // dgv_XuatHang
            // 
            dgv_XuatHang.AllowUserToResizeRows = false;
            ...
            dgv_XuatHang.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle4;
            dgv_XuatHang.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgv_XuatHang.BackgroundColor = Color.FromArgb(255, 255, 255);
            dgv_XuatHang.BorderStyle = System.Windows.Forms.BorderStyle.None;
            dgv_XuatHang.CellBorderStyle = DataGridViewCellBorderStyle.SingleVertical;
            dgv_XuatHang.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            ...
            dgv_XuatHang.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
            dgv_XuatHang.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgv_XuatHang.Columns.AddRange(new DataGridViewColumn[] { Column1, Column2, Column3 });
            ...
            dgv_XuatHang.DefaultCellStyle = dataGridViewCellStyle6;
            dgv_XuatHang.EnableHeadersVisualStyles = false;
            dgv_XuatHang.Font = new Font("Segoe UI", 11F, FontStyle.Regular, GraphicsUnit.Pixel);
            dgv_XuatHang.GridColor = Color.FromArgb(197, 198, 198);
            dgv_XuatHang.Location = new Point(269, 125);
            dgv_XuatHang.Name = "dgv_XuatHang";
            dgv_XuatHang.ReadOnly = true;
            dgv_XuatHang.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            ...
            dgv_XuatHang.RowHeadersDefaultCellStyle = dataGridViewCellStyle7;
            dgv_XuatHang.RowHeadersVisible = false;
            dgv_XuatHang.RowHeadersWidth = 51;
            dgv_XuatHang.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.DisableResizing;
            dgv_XuatHang.RowTemplate.Height = 29;
            dgv_XuatHang.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_XuatHang.Size = new Size(905, 463);
            dgv_XuatHang.TabIndex = 32;
            dgv_XuatHang.CellClick += dgv_XuatHang_CellClick;
            // 
            // Column1
            // 
            Column1.HeaderText = "Mã xuất hàng";
            ...
            Controls.Add(dgv_XuatHang);
            Controls.Add(metroGrid1);
            Controls.Add(btn_PhieuXuatHang);
            Controls.Add(label1);
            Controls.Add(roundedButton10);
            Name = "KiemKhoXuatHang";
            ((System.ComponentModel.ISupportInitialize)metroGrid1).EndInit();
            ((System.ComponentModel.ISupportInitialize)dgv_XuatHang).EndInit();
