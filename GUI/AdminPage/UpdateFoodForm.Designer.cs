namespace WinFormsApp2.AdminPage
{
    partial class UpdateFoodForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btn_ChooseDish = new CustomControls.RoundedButton();
            ...
            lbl_AccountName.Location = new Point(69, 82);
            ...
            pb_AccountIcon.Location = new Point(33, 84);
            ...
            // btn_ChooseDish
            // 
            btn_ChooseDish.BackColor = Color.FromArgb(229, 1, 17);
            btn_ChooseDish.BackgroundColor = Color.FromArgb(229, 1, 17);
            btn_ChooseDish.BorderColor = Color.PaleVioletRed;
            btn_ChooseDish.BorderRadius = 8;
            btn_ChooseDish.BorderSize = 0;
            btn_ChooseDish.FlatAppearance.BorderColor = Color.FromArgb(230, 57, 70);
            btn_ChooseDish.FlatStyle = FlatStyle.Flat;
            btn_ChooseDish.Font = new Font("Calibri", 12F, FontStyle.Bold, GraphicsUnit.Point);
            btn_ChooseDish.ForeColor = Color.White;
            btn_ChooseDish.Location = new Point(876, 419);
            btn_ChooseDish.Margin = new Padding(3, 4, 3, 4);
            btn_ChooseDish.Name = "btn_ChooseDish";
            btn_ChooseDish.Size = new Size(170, 35);
            btn_ChooseDish.TabIndex = 33;
            btn_ChooseDish.Text = "Cập nhật món ăn";
            btn_ChooseDish.TextColor = Color.White;
            btn_ChooseDish.UseVisualStyleBackColor = false;
            // 
            // tb_Price
            // 
