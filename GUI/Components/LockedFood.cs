...
{
    public partial class LockedFood : UserControl
    {
        public LockedFood()
        {
            InitializeComponent();
        ...
        public LockedFood(String IdFood, String ten, String gia, String URLImage, LockFood ContextLockFood)
        {
            InitializeComponent();
            this.IDFood = IdFood;
            TenMon = ten;
        ...
        public LockedFood(String ten, String gia, String URLImage, AllMonAn context)
        {
            InitializeComponent();
            TenMon = ten;
            Context = context;
        ...
        public LockedFood(String ten, String gia, String URLImage, HomepageFormSingle context)
        {
            InitializeComponent();
            TenMon = ten;
